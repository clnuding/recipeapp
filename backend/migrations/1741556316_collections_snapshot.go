		...
		jsonData := `[
			...
			},
			{
				...
				"fields": [
					...
					{
						"cascadeDelete": false,
						"collectionId": "pbc_3692165989",
						"hidden": false,
						"id": "relation837894034",
						"maxSelect": 1,
						"minSelect": 0,
						"name": "standard_measurement_id",
						"presentable": false,
						"required": false,
						"system": false,
						"type": "relation"
			...
			},
			{
				...
				"indexes": [],
				"listRule": null,
				"name": "ingredientDefaultMeasurements",
				"system": false,
				"type": "base",
				"updateRule": null,
				"viewRule": null
			...
			},
			{
				...
				"fields": [
					...
					},
					{
						"hidden": false,
						"id": "bool906147833",
						"name": "nutrition_auto_calculated",
						"presentable": false,
						"required": false,
						"system": false,
						"type": "bool"
